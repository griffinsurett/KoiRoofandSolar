...
export default function ServiceCard({ item, HasPage }) {
  ...
  return (
    <article className="service-card scale-up p-[var(--spacing-lg)] shadow hover:shadow-lg transition-shadow group flex flex-col justify-between items-center w-full min-h-[30vh] lg:min-h-[60vh] border-radius">
      {effectiveHasPage ? (
        <a
