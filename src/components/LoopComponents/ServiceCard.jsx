...
export default function ServiceCard({ item, HasPage }) {
  ...
  return (
    <li className="scale-up service-card p-[var(--spacing-lg)] shadow hover:shadow-lg transition-shadow group flex flex-col justify-between items-center w-full min-h-[30vh] lg:min-h-[50vh]">
      {effectiveHasPage ? (
        <a
