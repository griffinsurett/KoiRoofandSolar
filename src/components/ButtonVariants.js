...
export const baseButtonClasses =
  "relative border-radius items-center group uppercase text-center px-[var(--spacing-xl)] xl:px-[var(--spacing-3xl)] py-[var(--spacing-md)] font-medium w-full lg:w-auto transition-colors duration-300 ease-in-out";
